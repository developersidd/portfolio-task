    ...
    <div>
      ...
      <div className="flex font-rubik">
        <aside
          ...
          aria-label="Sidebar"
        >
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-deep-dark">
            <ul className="space-y-2 font-medium">
              <li>
                <Link
                  href="/dashboard"
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-dark-theme group"
                >
                  <svg
        ...
        ></div>
        <div className="w-full md:w-[calc(100vw-256px)] md:translate-x-[256px]">
          {children}
        </div>
      </div>
    </div>
