...
const AboutMe = () => {
  return (
    <section className=" flex flex-col items-center justify-between gap-8 py-16 md:flex-row md:gap-16">
      <div className="order-2 md:order-1 w-2/4">
        ...
        <Button
          ...
          btnClass="text-xs font-bold capitalize gap-4 bg-primary-orange px-8 py-4"
        />
      </div>
